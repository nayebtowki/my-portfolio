...
const Skills = () => {
    return (
        <section id='skills'>
            ...
            <span className="skillDesc">Combining the intricacies of Cybersecurity and the creativity of Full Stack Web Development, I deliver tailored tech solutions. My approach is rooted in a deep understanding of digital security, a flair for building engaging web interfaces.</span>
