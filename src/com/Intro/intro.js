    ...
    return (
        <section id="intro">
            <div className="introContent">
                ...
                <p className="introPara">As a passionate technologist, I am dedicated to merging the analytical rigor of cybersecurity and the creative artistry of web development. My journey is a blend of  securing digital landscapes and crafting engaging web experiences, showcasing a unique synergy between diverse technological domains.</p>
            <div>
